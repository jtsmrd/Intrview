...
class PersonalSummaryEditVC: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let personalSummary = profile.individualProfile?.personalSummary {
            personalSummaryTextView.text = personalSummary
        }
        else {
            personalSummaryTextView.text = "Personal Summary"
        }
    ...
    @objc func saveButtonAction() {
        ...
        profile.individualProfile?.personalSummary = personalSummaryTextView.text
        profile.save()
