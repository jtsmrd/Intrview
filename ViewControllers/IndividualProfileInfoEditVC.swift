//
//  IndividualProfileInfoEditVC.swift
//  SnapInterview
//
...
class IndividualProfileInfoEditVC: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @objc func saveButtonAction() {
        ...
        profile.individualProfile?.name = fullNameTextField.text
        profile.individualProfile?.profession = titleTextField.text
        profile.individualProfile?.location = locationTextField.text
        profile.individualProfile?.contactEmail = contactEmailTextField.text
        profile.individualProfile?.contactPhone = contactPhoneTextField.text
    ...
    private func configureView() {
        ...
        self.fullNameTextField.text = profile.individualProfile?.name
        self.titleTextField.text = profile.individualProfile?.profession
        self.locationTextField.text = profile.individualProfile?.location
        self.contactEmailTextField.text = profile.individualProfile?.contactEmail
        self.contactPhoneTextField.text = profile.individualProfile?.contactPhone
        
        if let image = profile.individualProfile?.profileImage {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        profile.individualProfile?.profileImage = image
        profile.individualProfile?.saveProfileImage(tempImageKey: imageKey)
